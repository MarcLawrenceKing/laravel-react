...
// ...props to save data in product-form, to edit/update]
export default function ProductForm({ ...props }) {
    const { product, isView, isEdit } = props;

    const breadcrumbs: BreadcrumbItem[] = [
        {
            //check condition on how the product form title should appear
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl border p-4">
                <div className="ml-auto">
                    <Link
                        as="button"
                        className="text-md flex w-fit cursor-pointer rounded-lg bg-indigo-800 px-4 py-2 text-white hover:opacity-90"
                            ...
                            <div className="grid gap-6">
                                ...
                                {(isView || isEdit) && product.featured_image && (
                                    <div className="grid gap-2">
                                        ...
                                        <img src={product.featured_image_url} alt="featured image" className="h-40 w-50 rounded-lg border" />
                                    </div>
                                )}
